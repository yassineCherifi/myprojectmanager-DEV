...
let AuthInterceptor = class AuthInterceptor {
    ...
    intercept(req, next) {
        ...
        return next.handle(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(event => { }, err => {
...
let ContributorComponent = class ContributorComponent {
    constructor(route, projectService, contributorService, userService) {
        this.route = route;
    ...
    onAdd($event) {
        this.waiting = true;
        this.contributorService.inviteContributor(this.projectId, $event).subscribe(res => {
            this.waiting = false;
            this.success = true;
...
ContributorComponent.ctorParameters = () => [
...
let DetailprojetComponent = class DetailprojetComponent {
    ...
    editProject(form) {
        ...
        const id = '_id';
        this.projetService.editProject(this.project[id], form.value).subscribe(res => {
            this.getProject();
        }, err => {
            console.log(err);
        });
...
let DetailsprintComponent = class DetailsprintComponent {
    ...
    getSprint() {
        ...
        this.sprintService.getSprint(this.projectId, this.sprintID).subscribe(data => {
            ...
            this.issueService.getIssues(this.projectId).subscribe(dataIssues => {
                const res = dataIssues[issues].filter(item1 => !this.sprint[issues].some(item2 => (item2._id === item1._id)));
                this.issues = res;
                this.nbrDifficulte = 0;
                this.nbrDifficulteRe = 0;
     ...
     */
    onAdd($event) {
        this.sprintService.addIssueSprint(this.projectId, this.sprintID, { idIssue: $event }).subscribe(res => {
            this.getSprint();
    ...
    onSubmitEditIssue(form) {
        this.issueService.editIssue(this.projectId, this.modelIssueEdit._id, form.value).subscribe(res => {
            form.resetForm();
            this.getSprint();
        }, err => {
            console.log(err);
...
let DocumentationComponent = class DocumentationComponent {
    constructor(documentationService, issueService, route) {
     ...
     */
    onSubmitDocumentation(form) {
        this.documentationService.addDocumentation(this.projectId, form.value).subscribe(res => {
            form.resetForm();
            this.getDocumentations();
        }, err => {
            console.log(err);
     ...
     */
    onSubmitEditDocumentation(form) {
        this.documentationService.editDocumentation(this.projectId, this.modelDocumentationEdit._id, form.value).subscribe(res => {
            form.resetForm();
            this.getDocumentations();
        }, err => {
            console.log(err);
...
let IssueComponent = class IssueComponent {
     ...
     */
    onSubmitIssue(form) {
        this.issueService.addIssue(this.projectId, form.value).subscribe(res => {
            form.resetForm();
...
let ReleaseComponent = class ReleaseComponent {
    constructor(releasesService, sprintService, issueService, route, calendar) {
     ...
     */
    onSubmitRelease(form) {
        const date = form.value.date;
        form.value.date = date.day + '/' + date.month + '/' + date.year;
        this.releasesService.addRelease(this.projectId, form.value).subscribe(res => {
            form.resetForm();
            this.getReleases();
        }, err => {
            console.log(err);
     ...
     * @param form form containing the release info
     */
    onSubmitEditRelease(form) {
        const date = form.value.date;
        form.value.date = date.day + '/' + date.month + '/' + date.year;
        this.releasesService.editRelease(this.projectId, this.modelReleaseEdit._id, form.value).subscribe(res => {
            form.resetForm();
            this.getReleases();
        }, err => {
            console.log(err);
...
let SprintComponent = class SprintComponent {
    ...
    onSubmitSprint(form) {
        ...
        this.sprintService.addSprint(this.projectId, form.value).subscribe(res => {
            form.resetForm();
    ...
    onSubmitEditSprint(form) {
        ...
        form.value.dp1 = startDate.day + '/' + startDate.month + '/' + startDate.year;
        form.value.dp2 = endDate.day + '/' + endDate.month + '/' + endDate.year;
        this.sprintService.editSprint(this.projectId, this.modelSprintEdit._id, form.value).subscribe(res => {
            form.resetForm();
...
let TaskComponent = class TaskComponent {
    constructor(tasksService, issueService, projectService, route) {
     ...
     */
    onSubmitTask(form) {
        this.tasksService.addTask(this.projectId, form.value).subscribe(res => {
            form.resetForm();
    ...
    onSubmitEditTask(form) {
        this.tasksService.editTask(this.projectId, this.modelTaskEdit._id, form.value).subscribe(res => {
            form.resetForm();
            this.getTasks();
        }, err => {
            console.log(err);
...
let TestComponent = class TestComponent {
    ...
    onSubmitTest(form) {
        ...
        this.testsService.addTest(this.projectId, form.value).subscribe(res => {
            form.resetForm();
    ...
    onSubmitEditTest(form) {
        const date = form.value.dp;
        form.value.dp = date.day + '/' + date.month + '/' + date.year;
        this.testsService.editTest(this.projectId, this.modelTestEdit._id, form.value).subscribe(res => {
            form.resetForm();
            this.getTests();
        }, err => {
            console.log(err);
...
let ListprojetsComponent = class ListprojetsComponent {
    constructor(projectsService, contributorService) {
     ...
     */
    onSubmit(form) {
        this.projectsService.addProject(form.value).subscribe(res => {
            form.resetForm();
            this.getProjects();
        }, err => {
            console.log(err);
...
ListprojetsComponent.ctorParameters = () => [
    { type: src_app_services_projet_service__WEBPACK_IMPORTED_MODULE_2__["ProjetService"] },
...
let ContributorService = class ContributorService {
    ...
    inviteContributor(idProject, email) {
        return this.httpClient.post(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].API_URL + '/projects/' + idProject + '/invite', { email });
    }
    /**
    ...
    addContributor(idProject, email) {
        return this.httpClient.post(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].API_URL + '/projects/' + idProject + '/contributors', { email });
    }
    /**
...
ContributorService.ctorParameters = () => [
...
let DocumentationsService = class DocumentationsService {
    constructor(httpClient) {
        this.httpClient = httpClient;
    }
    /**
...
DocumentationsService.ctorParameters = () => [
...
let ProjetService = class ProjetService {
    constructor(httpClient, userervice) {
        this.httpClient = httpClient;
