...
| US12 | Project contributor | to search in the list of issues in the sprints tab | I can select the required issues | LOW | 3 | 2 | TODO |
| US13 | Project contributor | to sort the list of issues by difficulty or priority in the sprints tab  | I can select the required issues | LOW | 3 | 2 | TODO |
