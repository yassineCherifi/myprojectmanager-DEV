...
| US11 | Project contributor | to add a list of tasks to the sprint by clicking on the button "Add task to the sprint" then choosing items among the list of tasks displayed on the form then confirming or cancelling | I can specify the required tasks for the sprint | LOW | 3 | 2 | TODO |
| US13 | Project contributor | to sort the list of tasks by difficulty or priority in the sprints tab  | that facilitates the planification of the sprint | LOW | 3 | 2 | TODO |
| US14 | Project contributor | to delete a task from the sprint by clicking on the corresponding button | I can update the list of tasks in the sprint | LOW | 1 | 2 |TODO |
